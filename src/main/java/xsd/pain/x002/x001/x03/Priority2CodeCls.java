...
public class Priority2CodeCls extends biz.c24.io.api.data.GenericStringDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.pain.x002.x001.x03.Priority2CodeCls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        addValidator(iso.std.iso.x20022.tech.xsd.pain.x002.x001.x03.Priority2CodeCls.Priority2Code1Enum.getInstance());
    }
    ...
    public static class Priority2Code1Enum extends biz.c24.io.api.data.DefaultEnumeration {
        ...
        public static biz.c24.io.api.data.Enumeration getInstance() {
            if (instance == null)
                instance = new iso.std.iso.x20022.tech.xsd.pain.x002.x001.x03.Priority2CodeCls.Priority2Code1Enum();
