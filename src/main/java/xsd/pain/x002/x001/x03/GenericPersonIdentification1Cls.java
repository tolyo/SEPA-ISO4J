...
public class GenericPersonIdentification1Cls extends biz.c24.io.api.data.ComplexDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.pain.x002.x001.x03.GenericPersonIdentification1Cls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        setValidObjectClass(iso.std.iso.x20022.tech.xsd.pain.x002.x001.x03.GenericPersonIdentification1.class);
        ...
        addElementDecl(element = new biz.c24.io.api.data.Element("SchmeNm", 0, 1, iso.std.iso.x20022.tech.xsd.pain.x002.x001.x03.PersonIdentificationSchemeName1ChoiceCls.class, iso.std.iso.x20022.tech.xsd.pain.x002.x001.x03.Pain00200103DataModel.getInstance()));
        element.setIgnoredElement(false);
