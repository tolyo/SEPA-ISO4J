 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1ChoiceCls
 */
public class CategoryPurpose1Choice extends biz.c24.io.api.data.ComplexDataObject {
     ...
     */
    private iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1 categoryPurpose1ChoiceSG1;

    public CategoryPurpose1Choice() {
        this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1ChoiceCls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public CategoryPurpose1Choice(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        {
            case 0:
                setCategoryPurpose1ChoiceSG1((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice) clone;
        obj.categoryPurpose1ChoiceSG1 = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1) biz.c24.io.api.Utils.cloneDeep(this.categoryPurpose1ChoiceSG1, obj, "CategoryPurpose1Choice-SG1");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1 createCategoryPurpose1ChoiceSG1() {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1) getElementDecl("CategoryPurpose1Choice-SG1").createObject();
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1 getCategoryPurpose1ChoiceSG1() {
     ...
     */
    public void setCategoryPurpose1ChoiceSG1(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1 value) {
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        this.categoryPurpose1ChoiceSG1 = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1) in.readObject();
    }
     ...
     * @version $Revision$ $Date$
     * @see
     * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1ChoiceCls.CategoryPurpose1ChoiceSG1Cls
     */
    public static class CategoryPurpose1ChoiceSG1 extends biz.c24.io.api.data.ComplexDataObject {
        ...
        public CategoryPurpose1ChoiceSG1() {
            this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1ChoiceCls.CategoryPurpose1ChoiceSG1Cls.getInstance().getNullDefiningElementDecl());
        }
        ...
        public CategoryPurpose1ChoiceSG1(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1 clone) {
            super(clone);
        }
         ...
         */
        public java.lang.Object clone() {
            return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1(this);
        }
         ...
         */
        public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
            biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1(this);
            cloneDeep(obj);
            return obj;
        }
         ...
         */
        protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
            iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CategoryPurpose1Choice.CategoryPurpose1ChoiceSG1) clone;
