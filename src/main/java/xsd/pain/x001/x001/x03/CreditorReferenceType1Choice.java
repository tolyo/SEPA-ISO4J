 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1ChoiceCls
 */
public class CreditorReferenceType1Choice extends biz.c24.io.api.data.ComplexDataObject {
     ...
     */
    private iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1 creditorReferenceType1ChoiceSG1;

    public CreditorReferenceType1Choice() {
        this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1ChoiceCls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public CreditorReferenceType1Choice(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        {
            case 0:
                setCreditorReferenceType1ChoiceSG1((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice) clone;
        obj.creditorReferenceType1ChoiceSG1 = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1) biz.c24.io.api.Utils.cloneDeep(this.creditorReferenceType1ChoiceSG1, obj, "CreditorReferenceType1Choice-SG1");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1 createCreditorReferenceType1ChoiceSG1() {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1) getElementDecl("CreditorReferenceType1Choice-SG1").createObject();
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1 getCreditorReferenceType1ChoiceSG1() {
     ...
     */
    public void setCreditorReferenceType1ChoiceSG1(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1 value) {
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        this.creditorReferenceType1ChoiceSG1 = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1) in.readObject();
    }
     ...
     * @version $Revision$ $Date$
     * @see
     * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1ChoiceCls.CreditorReferenceType1ChoiceSG1Cls
     */
    public static class CreditorReferenceType1ChoiceSG1 extends biz.c24.io.api.data.ComplexDataObject {
        ...
        public CreditorReferenceType1ChoiceSG1() {
            this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1ChoiceCls.CreditorReferenceType1ChoiceSG1Cls.getInstance().getNullDefiningElementDecl());
        }
        ...
        public CreditorReferenceType1ChoiceSG1(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1 clone) {
            super(clone);
        }
         ...
         */
        public java.lang.Object clone() {
            return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1(this);
        }
         ...
         */
        public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
            biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1(this);
            cloneDeep(obj);
            return obj;
        }
         ...
         */
        protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
            iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CreditorReferenceType1Choice.CreditorReferenceType1ChoiceSG1) clone;
