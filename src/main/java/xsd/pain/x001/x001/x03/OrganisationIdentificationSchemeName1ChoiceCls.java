...
public class OrganisationIdentificationSchemeName1ChoiceCls extends biz.c24.io.api.data.ComplexDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.OrganisationIdentificationSchemeName1ChoiceCls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        setValidObjectClass(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.OrganisationIdentificationSchemeName1Choice.class);
        setContentModel(biz.c24.io.api.data.ContentModelEnum.SEQUENCE);
        biz.c24.io.api.data.Element element = null;
        addElementDecl(element = new biz.c24.io.api.data.Element("OrganisationIdentificationSchemeName1Choice-SG1", 1, 1, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.OrganisationIdentificationSchemeName1ChoiceCls.OrganisationIdentificationSchemeName1ChoiceSG1Cls.class, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Pain00100103DataModel.getInstance()));
    ...
    public static class OrganisationIdentificationSchemeName1ChoiceSG1Cls extends biz.c24.io.api.data.ComplexDataType {
         ...
         * Field instance.
         */
        protected static volatile iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.OrganisationIdentificationSchemeName1ChoiceCls.OrganisationIdentificationSchemeName1ChoiceSG1Cls instance;
        ...
        public static biz.c24.io.api.data.DataType getInstance() {
            if (!initialized)
            {
                synchronized (biz.c24.io.api.data.ComplexDataType.class)
                {
                    if (instance == null)
                    {
                        instance = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.OrganisationIdentificationSchemeName1ChoiceCls.OrganisationIdentificationSchemeName1ChoiceSG1Cls();
                        instance.init();
                        initialized = true;
                    }
                }
        ...
        protected void init() {
            ...
            setLocal(true);
            setValidObjectClass(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.OrganisationIdentificationSchemeName1Choice.OrganisationIdentificationSchemeName1ChoiceSG1.class);
            setElementGroup(true);
            setContentModel(biz.c24.io.api.data.ContentModelEnum.CHOICE);
            biz.c24.io.api.data.Element element = null;
            addElementDecl(element = new biz.c24.io.api.data.Element("Cd", 1, 1, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ExternalOrganisationIdentification1CodeCls.class, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Pain00100103DataModel.getInstance()));
            element.setIgnoredElement(false);
