 ...
 * @see iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxPeriod1Cls
 */
public class TaxPeriod1 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field frToDt.
     */
    private iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails frToDt;

    public TaxPeriod1() {
        this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxPeriod1Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public TaxPeriod1(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxPeriod1 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 1:
                ...
                return;
            case 0:
                setFrToDt((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxPeriod1(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxPeriod1(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxPeriod1 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxPeriod1) clone;
        ...
        obj.frToDt = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails) biz.c24.io.api.Utils.cloneDeep(this.frToDt, obj, "FrToDt");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails createFrToDt() {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails) getElementDecl("FrToDt").createObject();
        setFrToDt(obj);
        return obj;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails getFrToDt() {
        return this.frToDt;
    }
     ...
     */
    public void setFrToDt(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails value) {
        this.frToDt = value;
        if (this.frToDt != null)
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.frToDt = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.DatePeriodDetails) in.readObject();
    }
