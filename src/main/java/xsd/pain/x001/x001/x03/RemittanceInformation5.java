 ...
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7}
 * (0..*)</li>
 * </ul>
 * 
 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.RemittanceInformation5Cls
 */
public class RemittanceInformation5 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field strd.
     */
    private iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[] strd;

    public RemittanceInformation5() {
        this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.RemittanceInformation5Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public RemittanceInformation5(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.RemittanceInformation5 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            case 1:
                ...
                return;
            case 0:
                addStrd((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7) value);
                return;
            default:
     ...
     */
    public void addStrd(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7 value) {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[] temp = this.strd;
        this.strd = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[temp == null ? 1 : (temp.length+1)];
        if (temp != null)
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.RemittanceInformation5(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.RemittanceInformation5(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.RemittanceInformation5 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.RemittanceInformation5) clone;
        obj.ustrd = (java.lang.String[]) biz.c24.io.api.Utils.cloneDeep(this.ustrd, obj, "Ustrd");
        obj.strd = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[]) biz.c24.io.api.Utils.cloneDeep(this.strd, obj, "Strd");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7 createStrd() {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7) getElementDecl("Strd").createObject();
        addStrd(obj);
        return obj;
    }
    ...
    public int getElementIndex(java.lang.String name,java.lang.Object element) {
        ...
        switch (i)
        {
            ...
            case 0:
                return getStrdIndex((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7) element);
            default:
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[] getStrd() {
        if (this.strd == null)
            return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[]{};
        else
            return this.strd;
    }
     ...
     * @param ordinal
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7 getStrd(int ordinal) {
        if (this.strd == null)
     ...
     * @return The index.
     */
    public int getStrdIndex(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7 value) {
        if (this.strd == null)
            return -1;
    ...
    public void removeStrd(int index) {
        if (this.strd == null)
            throw new java.lang.ArrayIndexOutOfBoundsException();
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[] temp = this.strd;
        this.strd = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[temp.length-1];
    ...
    public void setElement(java.lang.String name,int index,java.lang.Object value) {
        ...
        switch (i)
        {
            case 1:
                ...
                return;
            case 0:
                if (value != null && value instanceof iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[]) {
                    setStrd((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[])value);
                } else if (this.strd == null) {
                    throw new java.lang.ArrayIndexOutOfBoundsException();
                } else if (value == null) {
                    removeElement(name, index);
                } else {
                    this.strd[index] = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7) value;
     ...
     */
    public void setStrd(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[] value) {
        this.strd = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[]) biz.c24.io.api.Utils.clearNulls(value);
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.strd = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.StructuredRemittanceInformation7[]) in.readObject();
    }
