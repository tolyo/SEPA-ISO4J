 ...
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1}
 * (0..1)</li>
 * </ul>
 * 
 ...
 * @see iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxParty2Cls
 */
public class TaxParty2 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field authstn.
     */
    private iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1 authstn;

    public TaxParty2() {
        this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxParty2Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public TaxParty2(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxParty2 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 3:
                ...
                return;
            case 0:
                setAuthstn((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxParty2(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxParty2(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxParty2 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxParty2) clone;
        ...
        obj.authstn = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1) biz.c24.io.api.Utils.cloneDeep(this.authstn, obj, "Authstn");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1 createAuthstn() {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1) getElementDecl("Authstn").createObject();
        setAuthstn(obj);
        return obj;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1 getAuthstn() {
        return this.authstn;
    }
     ...
     */
    public void setAuthstn(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1 value) {
        this.authstn = value;
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.authstn = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.TaxAuthorisation1) in.readObject();
    }
