...
public class PartyIdentification32Cls extends biz.c24.io.api.data.ComplexDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32Cls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        setValidObjectClass(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32.class);
        ...
        element.setIgnoredElement(false);
        addElementDecl(element = new biz.c24.io.api.data.Element("Id", 0, 1, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6ChoiceCls.class, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Pain00100103DataModel.getInstance()));
        element.setIgnoredElement(false);
        addElementDecl(element = new biz.c24.io.api.data.Element("CtryOfRes", 0, 1, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.CountryCodeCls.class, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Pain00100103DataModel.getInstance()));
        element.setIgnoredElement(false);
        addElementDecl(element = new biz.c24.io.api.data.Element("CtctDtls", 0, 1, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2Cls.class, iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Pain00100103DataModel.getInstance()));
        element.setIgnoredElement(false);
    }
