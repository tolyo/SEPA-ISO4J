 ...
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice}
 * (0..1)</li>
 * <li><b>CtryOfRes</b> of type {@link java.lang.String}
 * (0..1)</li>
 * <li><b>CtctDtls</b> of type {@link
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2}
 * (0..1)</li>
 * </ul>
 * 
 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32Cls
 */
public class PartyIdentification32 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field id.
     */
    private iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice id;
     ...
     * Field ctctDtls.
     */
    private iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2 ctctDtls;

    public PartyIdentification32() {
        this(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public PartyIdentification32(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 4:
                ...
                return;
            case 2:
                setId((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice) value);
                return;
            case 1:
                setCtryOfRes((java.lang.String) value);
                return;
            case 0:
                setCtctDtls((iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.PartyIdentification32) clone;
        ...
        obj.id = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice) biz.c24.io.api.Utils.cloneDeep(this.id, obj, "Id");
        obj.ctryOfRes = (java.lang.String) biz.c24.io.api.Utils.cloneDeep(this.ctryOfRes, obj, "CtryOfRes");
        obj.ctctDtls = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2) biz.c24.io.api.Utils.cloneDeep(this.ctctDtls, obj, "CtctDtls");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2 createCtctDtls() {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2 obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2) getElementDecl("CtctDtls").createObject();
        setCtctDtls(obj);
        return obj;
    }
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice createId() {
        iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice obj = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice) getElementDecl("Id").createObject();
        setId(obj);
        return obj;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2 getCtctDtls() {
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice getId() {
        return this.id;
    }
     ...
     */
    public void setCtctDtls(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2 value) {
        this.ctctDtls = value;
     ...
     * @param value The new value.
     */
    public void setId(iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice value) {
        this.id = value;
        if (this.id != null)
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.id = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.Party6Choice) in.readObject();
        this.ctryOfRes = (java.lang.String) in.readObject();
        this.ctctDtls = (iso.std.iso.x20022.tech.xsd.pain.x001.x001.x03.ContactDetails2) in.readObject();
    }
