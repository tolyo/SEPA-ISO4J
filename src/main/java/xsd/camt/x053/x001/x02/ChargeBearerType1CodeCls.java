...
public class ChargeBearerType1CodeCls extends biz.c24.io.api.data.GenericStringDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ChargeBearerType1CodeCls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        addValidator(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ChargeBearerType1CodeCls.ChargeBearerType1Code1Enum.getInstance());
    }
    ...
    public static class ChargeBearerType1Code1Enum extends biz.c24.io.api.data.DefaultEnumeration {
        ...
        public static biz.c24.io.api.data.Enumeration getInstance() {
            if (instance == null)
                instance = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ChargeBearerType1CodeCls.ChargeBearerType1Code1Enum();
