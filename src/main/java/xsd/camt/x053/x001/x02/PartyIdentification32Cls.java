...
public class PartyIdentification32Cls extends biz.c24.io.api.data.ComplexDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.PartyIdentification32Cls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        setValidObjectClass(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.PartyIdentification32.class);
        ...
        element.setIgnoredElement(false);
        addElementDecl(element = new biz.c24.io.api.data.Element("Id", 0, 1, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.Party6ChoiceCls.class, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.Camt05300102DataModel.getInstance()));
        element.setIgnoredElement(false);
        addElementDecl(element = new biz.c24.io.api.data.Element("CtryOfRes", 0, 1, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.CountryCodeCls.class, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.Camt05300102DataModel.getInstance()));
        element.setIgnoredElement(false);
        addElementDecl(element = new biz.c24.io.api.data.Element("CtctDtls", 0, 1, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ContactDetails2Cls.class, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.Camt05300102DataModel.getInstance()));
        element.setIgnoredElement(false);
    }
