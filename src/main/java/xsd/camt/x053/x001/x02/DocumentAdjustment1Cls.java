 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.DocumentAdjustment
 */
public class DocumentAdjustment1Cls extends biz.c24.io.api.data.ComplexDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.DocumentAdjustment1Cls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        setValidObjectClass(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.DocumentAdjustment1.class);
        ...
        element.setIgnoredElement(false);
        addElementDecl(element = new biz.c24.io.api.data.Element("Rsn", 0, 1, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.Max4TextCls.class, iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.Camt05300102DataModel.getInstance()));
        element.setIgnoredElement(false);
