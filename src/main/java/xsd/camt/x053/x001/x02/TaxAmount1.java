 ...
 * iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1}
 * (0..*)</li>
 * </ul>
 * 
 ...
 * @see iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxAmount1Cls
 */
public class TaxAmount1 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field taxblBaseAmt.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount taxblBaseAmt;
     ...
     * Field dtls.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[] dtls;

    public TaxAmount1() {
        this(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxAmount1Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public TaxAmount1(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxAmount1 clone) {
        super(clone);
    }
     ...
     */
    public void addDtls(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1 value) {
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[] temp = this.dtls;
        this.dtls = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[temp == null ? 1 : (temp.length+1)];
        if (temp != null)
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            case 1:
                ...
                return;
            case 2:
                setTaxblBaseAmt((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount) value);
                return;
            case 3:
                setTtlAmt((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount) value);
                return;
            case 0:
                addDtls((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxAmount1(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxAmount1(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxAmount1 obj = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxAmount1) clone;
        obj.rate = (java.math.BigDecimal) biz.c24.io.api.Utils.cloneDeep(this.rate, obj, "Rate");
        obj.taxblBaseAmt = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount) biz.c24.io.api.Utils.cloneDeep(this.taxblBaseAmt, obj, "TaxblBaseAmt");
        ...
        obj.dtls = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[]) biz.c24.io.api.Utils.cloneDeep(this.dtls, obj, "Dtls");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1 createDtls() {
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1 obj = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1) getElementDecl("Dtls").createObject();
        addDtls(obj);
        return obj;
    }
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount createTaxblBaseAmt() {
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount obj = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount) getElementDecl("TaxblBaseAmt").createObject();
        setTaxblBaseAmt(obj);
        return obj;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[] getDtls() {
        if (this.dtls == null)
            return new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[]{};
        else
            return this.dtls;
    }
     ...
     * @param ordinal
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1 getDtls(int ordinal) {
        if (this.dtls == null)
     ...
     * @return The index.
     */
    public int getDtlsIndex(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1 value) {
        if (this.dtls == null)
            return -1;
    ...
    public int getElementIndex(java.lang.String name,java.lang.Object element) {
        ...
        switch (i)
        {
            ...
            case 0:
                return getDtlsIndex((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1) element);
            default:
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount getTaxblBaseAmt() {
        return this.taxblBaseAmt;
    }
    ...
    public void removeDtls(int index) {
        if (this.dtls == null)
            throw new java.lang.ArrayIndexOutOfBoundsException();
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[] temp = this.dtls;
        this.dtls = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[temp.length-1];
     ...
     */
    public void setDtls(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[] value) {
        this.dtls = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[]) biz.c24.io.api.Utils.clearNulls(value);
    ...
    public void setElement(java.lang.String name,int index,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 3:
                ...
                return;
            case 0:
                if (value != null && value instanceof iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[]) {
                    setDtls((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[])value);
                } else if (this.dtls == null) {
                    throw new java.lang.ArrayIndexOutOfBoundsException();
                } else if (value == null) {
                    removeElement(name, index);
                } else {
                    this.dtls[index] = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1) value;
     ...
     * @param value The new value.
     */
    public void setTaxblBaseAmt(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount value) {
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.taxblBaseAmt = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount) in.readObject();
        this.ttlAmt = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ActiveOrHistoricCurrencyAndAmount) in.readObject();
        this.dtls = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TaxRecordDetails1[]) in.readObject();
    }
