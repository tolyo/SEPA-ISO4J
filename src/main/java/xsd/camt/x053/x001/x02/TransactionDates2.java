 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TransactionDates2Cls
 */
public class TransactionDates2 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field prtry.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[] prtry;

    public TransactionDates2() {
        this(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TransactionDates2Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public TransactionDates2(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TransactionDates2 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 7:
                ...
                return;
            case 3:
                addPrtry((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2) value);
                return;
            default:
     ...
     */
    public void addPrtry(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2 value) {
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[] temp = this.prtry;
        this.prtry = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[temp == null ? 1 : (temp.length+1)];
        if (temp != null)
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TransactionDates2(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TransactionDates2(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TransactionDates2 obj = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.TransactionDates2) clone;
        ...
        obj.prtry = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[]) biz.c24.io.api.Utils.cloneDeep(this.prtry, obj, "Prtry");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2 createPrtry() {
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2 obj = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2) getElementDecl("Prtry").createObject();
        addPrtry(obj);
        return obj;
    }
    ...
    public int getElementIndex(java.lang.String name,java.lang.Object element) {
        ...
        switch (i)
        {
            ...
            case 3:
                return getPrtryIndex((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2) element);
            default:
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[] getPrtry() {
        if (this.prtry == null)
            return new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[]{};
        else
            return this.prtry;
    }
     ...
     * @param ordinal
     */
    public iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2 getPrtry(int ordinal) {
        if (this.prtry == null)
     ...
     * @return The index.
     */
    public int getPrtryIndex(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2 value) {
        if (this.prtry == null)
            return -1;
    ...
    public void removePrtry(int index) {
        if (this.prtry == null)
            throw new java.lang.ArrayIndexOutOfBoundsException();
        iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[] temp = this.prtry;
        this.prtry = new iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[temp.length-1];
    ...
    public void setElement(java.lang.String name,int index,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 7:
                ...
                return;
            case 3:
                if (value != null && value instanceof iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[]) {
                    setPrtry((iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[])value);
                } else if (this.prtry == null) {
                    throw new java.lang.ArrayIndexOutOfBoundsException();
                } else if (value == null) {
                    removeElement(name, index);
                } else {
                    this.prtry[index] = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2) value;
     ...
     * @param value The new value.
     */
    public void setPrtry(iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[] value) {
        this.prtry = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[]) biz.c24.io.api.Utils.clearNulls(value);
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.prtry = (iso.std.iso.x20022.tech.xsd.camt.x053.x001.x02.ProprietaryDate2[]) in.readObject();
    }
