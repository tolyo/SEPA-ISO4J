 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CurrencyAndAmountRange2Cls
 */
public class CurrencyAndAmountRange2 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field amt.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice amt;
    ...
    public CurrencyAndAmountRange2() {
        this(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CurrencyAndAmountRange2Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public CurrencyAndAmountRange2(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CurrencyAndAmountRange2 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        {
            case 0:
                setAmt((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice) value);
                return;
            case 2:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CurrencyAndAmountRange2(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CurrencyAndAmountRange2(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CurrencyAndAmountRange2 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CurrencyAndAmountRange2) clone;
        obj.amt = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice) biz.c24.io.api.Utils.cloneDeep(this.amt, obj, "Amt");
     ...
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice createAmt() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice) getElementDecl("Amt").createObject();
        setAmt(obj);
        return obj;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice getAmt() {
        return this.amt;
    }
     ...
     */
    public void setAmt(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice value) {
        this.amt = value;
        if (this.amt != null)
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        this.amt = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ImpliedCurrencyAmountRangeChoice) in.readObject();
