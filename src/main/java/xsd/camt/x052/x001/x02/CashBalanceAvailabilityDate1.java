 ...
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1}
 * (1)</li>
 * </ul>
 * 
 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1Cls
 */
public class CashBalanceAvailabilityDate1 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1 cashBalanceAvailabilityDate1SG1;

    public CashBalanceAvailabilityDate1() {
        this(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public CashBalanceAvailabilityDate1(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        {
            case 0:
                setCashBalanceAvailabilityDate1SG1((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1) clone;
        obj.cashBalanceAvailabilityDate1SG1 = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1) biz.c24.io.api.Utils.cloneDeep(this.cashBalanceAvailabilityDate1SG1, obj, "CashBalanceAvailabilityDate1-SG1");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1 createCashBalanceAvailabilityDate1SG1() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1) getElementDecl("CashBalanceAvailabilityDate1-SG1").createObject();
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1 getCashBalanceAvailabilityDate1SG1() {
     ...
     */
    public void setCashBalanceAvailabilityDate1SG1(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1 value) {
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        this.cashBalanceAvailabilityDate1SG1 = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1) in.readObject();
    }
     ...
     * @version $Revision$ $Date$
     * @see
     * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1Cls.CashBalanceAvailabilityDate1SG1Cls
     */
    public static class CashBalanceAvailabilityDate1SG1 extends biz.c24.io.api.data.ComplexDataObject {
        ...
        public CashBalanceAvailabilityDate1SG1() {
            this(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1Cls.CashBalanceAvailabilityDate1SG1Cls.getInstance().getNullDefiningElementDecl());
        }
        ...
        public CashBalanceAvailabilityDate1SG1(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1 clone) {
            super(clone);
        }
         ...
         */
        public java.lang.Object clone() {
            return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1(this);
        }
         ...
         */
        public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
            biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1(this);
            cloneDeep(obj);
            return obj;
        }
         ...
         */
        protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
            iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.CashBalanceAvailabilityDate1.CashBalanceAvailabilityDate1SG1) clone;
