 ...
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice}
 * (0..1)</li>
 * <li><b>Rate</b> of type {@link
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3}
 * (0..*)</li>
 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2Cls
 */
public class TransactionInterest2 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field tp.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice tp;

    /**
     * Field rate.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[] rate;
    ...
    public TransactionInterest2() {
        this(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public TransactionInterest2(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 1:
                ...
                return;
            case 5:
                setTp((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice) value);
                return;
            case 3:
                addRate((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3) value);
                return;
            case 2:
     ...
     */
    public void addRate(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3 value) {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[] temp = this.rate;
        this.rate = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[temp == null ? 1 : (temp.length+1)];
        if (temp != null)
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2) clone;
        ...
        obj.tp = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice) biz.c24.io.api.Utils.cloneDeep(this.tp, obj, "Tp");
        obj.rate = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[]) biz.c24.io.api.Utils.cloneDeep(this.rate, obj, "Rate");
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3 createRate() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3) getElementDecl("Rate").createObject();
        addRate(obj);
        return obj;
    }
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice createTp() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice) getElementDecl("Tp").createObject();
        setTp(obj);
        return obj;
    }
    ...
    public int getElementIndex(java.lang.String name,java.lang.Object element) {
        ...
        switch (i)
        {
            ...
            case 3:
                return getRateIndex((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3) element);
            case 2:
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[] getRate() {
        if (this.rate == null)
            return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[]{};
        else
            return this.rate;
    }
     ...
     * @param ordinal
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3 getRate(int ordinal) {
        if (this.rate == null)
     ...
     * @return The index.
     */
    public int getRateIndex(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3 value) {
        if (this.rate == null)
            return -1;
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice getTp() {
        return this.tp;
    }
    ...
    public void removeRate(int index) {
        if (this.rate == null)
            throw new java.lang.ArrayIndexOutOfBoundsException();
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[] temp = this.rate;
        this.rate = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[temp.length-1];
    ...
    public void setElement(java.lang.String name,int index,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 5:
                ...
                return;
            case 3:
                if (value != null && value instanceof iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[]) {
                    setRate((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[])value);
                } else if (this.rate == null) {
                    throw new java.lang.ArrayIndexOutOfBoundsException();
                } else if (value == null) {
                    removeElement(name, index);
                } else {
                    this.rate[index] = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3) value;
     ...
     * @param value The new value.
     */
    public void setRate(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[] value) {
        this.rate = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[]) biz.c24.io.api.Utils.clearNulls(value);
     ...
     * @param value The new value.
     */
    public void setTp(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice value) {
        this.tp = value;
        if (this.tp != null)
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.tp = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.InterestType1Choice) in.readObject();
        this.rate = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.Rate3[]) in.readObject();
