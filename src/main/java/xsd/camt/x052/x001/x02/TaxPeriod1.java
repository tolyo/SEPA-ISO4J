 ...
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails}
 * (0..1)</li>
 * </ul>
 * 
 ...
 * @see iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxPeriod1Cls
 */
public class TaxPeriod1 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field frToDt.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails frToDt;

    public TaxPeriod1() {
        this(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxPeriod1Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public TaxPeriod1(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxPeriod1 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            ...
            case 1:
                ...
                return;
            case 0:
                setFrToDt((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxPeriod1(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxPeriod1(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxPeriod1 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxPeriod1) clone;
        ...
        obj.frToDt = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails) biz.c24.io.api.Utils.cloneDeep(this.frToDt, obj, "FrToDt");
    }
     ...
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails createFrToDt() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails) getElementDecl("FrToDt").createObject();
        setFrToDt(obj);
        return obj;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails getFrToDt() {
        return this.frToDt;
    }
     ...
     */
    public void setFrToDt(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails value) {
        this.frToDt = value;
        if (this.frToDt != null)
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.frToDt = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.DatePeriodDetails) in.readObject();
    }
