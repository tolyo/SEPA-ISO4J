...
public class TransactionInterest2Cls extends biz.c24.io.api.data.ComplexDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2Cls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        setValidObjectClass(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TransactionInterest2.class);
