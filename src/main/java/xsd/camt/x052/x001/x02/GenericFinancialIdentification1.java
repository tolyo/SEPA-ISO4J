 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.GenericFinancialIdentification1Cls
 */
public class GenericFinancialIdentification1 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     * Field schmeNm.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice schmeNm;
    ...
    public GenericFinancialIdentification1() {
        this(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.GenericFinancialIdentification1Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public GenericFinancialIdentification1(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.GenericFinancialIdentification1 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        switch (i)
        {
            case 0:
                ...
                return;
            case 2:
                setSchmeNm((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice) value);
                return;
            case 1:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.GenericFinancialIdentification1(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.GenericFinancialIdentification1(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.GenericFinancialIdentification1 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.GenericFinancialIdentification1) clone;
        obj.id = (java.lang.String) biz.c24.io.api.Utils.cloneDeep(this.id, obj, "Id");
        obj.schmeNm = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice) biz.c24.io.api.Utils.cloneDeep(this.schmeNm, obj, "SchmeNm");
     ...
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice createSchmeNm() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice) getElementDecl("SchmeNm").createObject();
        setSchmeNm(obj);
        return obj;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice getSchmeNm() {
        return this.schmeNm;
    }
     ...
     * @param value The new value.
     */
    public void setSchmeNm(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice value) {
        this.schmeNm = value;
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        this.schmeNm = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.FinancialIdentificationSchemeName1Choice) in.readObject();
