 ...
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2}
 * (0..1)</li>
 * </ul>
 * 
 ...
 * @see
 * iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargesInformation6Cls
 */
public class ChargesInformation6 extends biz.c24.io.api.data.ComplexDataObject {
     ...
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount ttlChrgsAndTaxAmt;
     ...
     * Field tp.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice tp;
     ...
     * Field pty.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4 pty;

    /**
     * Field tax.
     */
    private iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2 tax;

    public ChargesInformation6() {
        this(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargesInformation6Cls.getInstance().getNullDefiningElementDecl());
    }
    ...
    public ChargesInformation6(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargesInformation6 clone) {
        super(clone);
    }
    ...
    public void addElement(java.lang.String name,java.lang.Object value) {
        ...
        {
            case 7:
                setTtlChrgsAndTaxAmt((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount) value);
                return;
            case 0:
            ...
            case 2:
                ...
                return;
            case 6:
                setTp((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice) value);
                return;
            case 4:
            ...
            case 1:
                ...
                return;
            case 3:
                setPty((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4) value);
                return;
            case 5:
                setTax((iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2) value);
                return;
            default:
    ...
    public java.lang.Object clone() {
        return new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargesInformation6(this);
    }
    ...
    public biz.c24.io.api.data.ComplexDataObject cloneDeep() throws java.lang.CloneNotSupportedException {
        biz.c24.io.api.data.ComplexDataObject obj = new iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargesInformation6(this);
        cloneDeep(obj);
        return obj;
    }
    ...
    protected void cloneDeep(biz.c24.io.api.data.ComplexDataObject clone) throws java.lang.CloneNotSupportedException {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargesInformation6 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargesInformation6) clone;
        obj.ttlChrgsAndTaxAmt = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount) biz.c24.io.api.Utils.cloneDeep(this.ttlChrgsAndTaxAmt, obj, "TtlChrgsAndTaxAmt");
        ...
        obj.tp = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice) biz.c24.io.api.Utils.cloneDeep(this.tp, obj, "Tp");
        ...
        obj.pty = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4) biz.c24.io.api.Utils.cloneDeep(this.pty, obj, "Pty");
        obj.tax = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2) biz.c24.io.api.Utils.cloneDeep(this.tax, obj, "Tax");
    }
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4 createPty() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4) getElementDecl("Pty").createObject();
        setPty(obj);
        return obj;
    }
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2 createTax() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2 obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2) getElementDecl("Tax").createObject();
        setTax(obj);
        return obj;
    }
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice createTp() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice) getElementDecl("Tp").createObject();
        setTp(obj);
        return obj;
    }
     ...
     * @return The new value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount createTtlChrgsAndTaxAmt() {
        iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount obj = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount) getElementDecl("TtlChrgsAndTaxAmt").createObject();
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4 getPty() {
        return this.pty;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2 getTax() {
        return this.tax;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice getTp() {
        return this.tp;
    }
     ...
     * @return The value.
     */
    public iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount getTtlChrgsAndTaxAmt() {
        return this.ttlChrgsAndTaxAmt;
    }
     ...
     * @param value The new value.
     */
    public void setPty(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4 value) {
        this.pty = value;
        if (this.pty != null)
     ...
     * @param value The new value.
     */
    public void setTax(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2 value) {
        this.tax = value;
        if (this.tax != null)
     ...
     * @param value The new value.
     */
    public void setTp(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice value) {
        this.tp = value;
        if (this.tp != null)
     ...
     * @param value The new value.
     */
    public void setTtlChrgsAndTaxAmt(iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount value) {
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        this.ttlChrgsAndTaxAmt = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ActiveOrHistoricCurrencyAndAmount) in.readObject();
        ...
        this.tp = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.ChargeType2Choice) in.readObject();
        this.rate = (java.math.BigDecimal) in.readObject();
        this.br = (java.lang.String) in.readObject();
        this.pty = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.BranchAndFinancialInstitutionIdentification4) in.readObject();
        this.tax = (iso.std.iso.x20022.tech.xsd.camt.x052.x001.x02.TaxCharges2) in.readObject();
    }
