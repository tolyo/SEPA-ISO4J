...
public class ActiveOrHistoricCurrencyAndAmountCls extends biz.c24.io.api.data.ComplexDataType {
    ...
    public static biz.c24.io.api.data.DataType getInstance() {
        if (!initialized)
        {
            synchronized (biz.c24.io.api.data.ComplexDataType.class)
            {
                if (instance == null)
                {
                    instance = new iso.std.iso.x20022.tech.xsd.camt.x060.x001.x03.ActiveOrHistoricCurrencyAndAmountCls();
                    instance.init();
                    initialized = true;
                }
            }
    ...
    protected void init() {
        ...
        setValidObjectClass(iso.std.iso.x20022.tech.xsd.camt.x060.x001.x03.ActiveOrHistoricCurrencyAndAmount.class);
        setContentModel(biz.c24.io.api.data.ContentModelEnum.SEQUENCE);
        setContentType((biz.c24.io.api.data.SimpleDataType) iso.std.iso.x20022.tech.xsd.camt.x060.x001.x03.ActiveOrHistoricCurrencyAndAmount_SimpleTypeCls.getInstance());
        biz.c24.io.api.data.Attribute attribute = null;
        addAttrDecl(attribute = new biz.c24.io.api.data.Attribute("Ccy", 1, 1, iso.std.iso.x20022.tech.xsd.camt.x060.x001.x03.ActiveOrHistoricCurrencyCodeCls.class, iso.std.iso.x20022.tech.xsd.camt.x060.x001.x03.Camt06000103DataModel.getInstance()));
    }
